...
const showRecipe = async function () {
  try {
    ...
    let { recipe } = data.data; //one data is our variable and another one is api's data

    //customizing the object with our property names
    recipe = {
      id: recipe.id,
      title: recipe.title,
  ...
  <div class="recipe__directions">
    ...
    recipeContainer.innerHTML = ''; //by this we can stop the spinner
...
//we can optimise the above code to
